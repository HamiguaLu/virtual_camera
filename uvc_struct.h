...
//Audio Definitions from  "Universal Serial Bus Device Class Definition for Audio Devices"

/*  B.3.3.2 Class-specific AC Interface Descriptor */
struct uac_cs_input_header_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u16 bcdADC;
...
struct uac_microphone_input_terminal_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bTerminalID;
...
struct uac_microphone0_output_terminal_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bTerminalID;
...
//reuse usb_interface_descriptor



/*B.3.4.2.1.2 Class - specific AS General Interface Descriptor*/
struct uac_microphone_terminal_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bTerminalLink;
...
struct uac_microphone_format_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bFormatType;
...
struct uac_microphone_data_descriptor {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bmAttributes;
